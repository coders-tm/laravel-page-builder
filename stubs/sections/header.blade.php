@schema([
    'name' => 'Header',
    'settings' => [['id' => 'title', 'type' => 'text', 'label' => 'Title', 'default' => 'Default Header Title'], ['id' => 'logo_image', 'type' => 'image_picker', 'label' => 'Logo Image', 'default' => '/statics/logo-dark.svg'], ['id' => 'logo_text', 'type' => 'text', 'label' => 'Logo Text', 'default' => 'PageBuilder'], ['id' => 'logo_badge', 'type' => 'text', 'label' => 'Logo Badge', 'default' => 'v1.0'], ['id' => 'sticky', 'type' => 'checkbox', 'label' => 'Sticky Header', 'default' => true], ['id' => 'github_url', 'type' => 'url', 'label' => 'GitHub URL', 'default' => 'https://github.com/coders-tm/laravel-page-builder'], ['id' => 'cta_label', 'type' => 'text', 'label' => 'CTA Label', 'default' => 'Get Started'], ['id' => 'cta_url', 'type' => 'url', 'label' => 'CTA URL', 'default' => '#pricing']],
    'blocks' => [
        [
            'type' => 'nav-link',
    ...
    'presets' => [
        [
            ...
            'blocks' => [['type' => 'nav-link', 'settings' => ['label' => 'Features', 'url' => '#features']], ['type' => 'nav-link', 'settings' => ['label' => 'How It Works', 'url' => '#how-it-works']], ['type' => 'nav-link', 'settings' => ['label' => 'Stats', 'url' => '#stats']], ['type' => 'nav-link', 'settings' => ['label' => 'Pricing', 'url' => '#pricing']], ['type' => 'nav-link', 'settings' => ['label' => 'FAQ', 'url' => '#faq']]],
        ],
    ],
])
...
@php
    ...
    $brandTitle =
        $section->settings->title && $section->settings->title !== 'Default Header Title'
    ...
    <div class="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-3">
            ...
            @if ($section->settings->logo_badge)
                <span
                    class="hidden sm:inline-flex items-center rounded-full bg-indigo-50 dark:bg-indigo-950/60 px-2.5 py-0.5 text-xs font-semibold text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800">
